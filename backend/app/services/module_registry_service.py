...
MODULE_REGISTRY: tuple[OsModule, ...] = (
    ...
    OsModule(
        ...
        api_prefixes=[
            ...
            "/api/v1/inventory-accounting",
            "/api/v1/tax-accounting",
            "/api/v1/accrual-amortization",
            "/api/v1/consolidation",
            "/api/v1/period-close",
            "/api/v1/financial-statements",
            "/api/v1/accounting-archive",
            "/api/v1/accounting-governance",
            "/api/v1/receivable-payable",
            "/api/v1/bank-reconciliation",
            "/api/v1/dashboard/report",
        ],
        capabilities=["智能记账", "凭证中心", "总账", "往来核算", "银行对账", "固定资产", "固定资产正式核算", "工资管理", "薪酬正式核算", "存货正式核算", "税务核算", "预提摊销与融资利息", "合并报表", "财务报表", "正式核算上线治理"],
        requires_permission=True,
        audit_events=[
            "voucher.create",
            "voucher.review",
            ...
            "inventory_accounting.balance.read",
            "inventory_accounting.receipt.post",
            "inventory_accounting.sales_issue.post",
            "inventory_accounting.impairment.post",
            "inventory_accounting.count_variance.post",
