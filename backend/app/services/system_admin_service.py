...
PERMISSIONS: tuple[PermissionItem, ...] = (
    ...
    PermissionItem(
        code="accounting_governance.read",
        name="查看上线治理",
        module_id="finance-center",
        action="read",
        description="查看正式核算完整性校验、迁移预览、备份恢复和上线门禁状态。",
        risk_level="high",
    ),
    PermissionItem(
        code="accounting_migration.preview",
        name="预览核算迁移",
        module_id="finance-center",
        action="read",
        description="执行 MVP 凭证到正式分录的迁移 dry-run 和差异报告。",
        risk_level="high",
    ),
    PermissionItem(
        code="accounting_migration.apply",
        name="执行核算迁移",
        module_id="finance-center",
        action="write",
        description="在备份、完整性校验和权限校验通过后执行受控迁移批次。",
        risk_level="high",
    ),
    PermissionItem(
        code="accounting_backup.create",
        name="创建核算备份",
        module_id="finance-center",
        action="write",
        description="创建正式核算上线前备份清单并发起恢复演练。",
        risk_level="high",
    ),
    PermissionItem(
        code="accounting_governance.approve_go_live",
        name="审批正式核算上线",
        module_id="finance-center",
        action="approve",
        description="在上线门禁全部通过后审批正式核算来源切换。",
        risk_level="high",
    ),
    PermissionItem(
